        ...
        <div className="bg-white border border-slate-100 rounded-3xl p-8 md:p-16 shadow-sm">
          <div className="max-w-4xl">
            ...
            <div className="space-y-10 text-slate-600 font-medium leading-relaxed text-lg">
              ...
              <section>
                <h2 className="text-2xl font-bold text-slate-900 mb-4">1. User Registration and Security</h2>
                <p>
              ...
              <section>
                <h2 className="text-2xl font-bold text-slate-900 mb-4">2. Prohibited Activities</h2>
