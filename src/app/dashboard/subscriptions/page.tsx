    ...
    <DashboardLayout>
      <div className="max-w-[1400px] mx-auto space-y-6 md:space-y-8">
        <div className="flex flex-col md:flex-row md:items-start justify-between gap-6">
          <div>
            <h1 className="dashboard-title text-3xl font-black tracking-tight">Subscriptions Management</h1>
            <p className="text-sm font-bold text-slate-400 dark:text-slate-500 mt-2">Manage subscription plans and customer subscriptions</p>
          </div>
          <button 
